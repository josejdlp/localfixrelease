...
public class NuevoDesperfecto extends AppCompatActivity {
    ...
    public void btn_agregar_nuevo_desperfecto(View view){
        ...
        //Imagenes, en la lista de urls

        //Ubicacion, queda por hacer....
        ...
        DesperfectoActivity nuevo = new DesperfectoActivity(id,"sgm00040",titulo,lat,lon, descripcion, gravedad,"", comentarios,listaUrls);
